...
try
{
    ...
    ip1=monitor_info_json["droplet-blue"].ip
	ip2=monitor_info_json["droplet-green"].ip
	var serverrport = fs.readFileSync('servername.json');
    serverrport=JSON.parse(serverrport)
    port=serverrport["port"]
...
[
	...
	{name: "droplet-blue",url:`http://${ip1}:${port}/`, status: "#cccccc",  scoreTrend : [0]},
	{name: "droplet-green",url:`http://${ip2}:${port}/`, status: "#cccccc",  scoreTrend : [0]}
];
